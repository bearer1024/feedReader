<?php
define('FEEDREADER_VERSION', '1.0.0');
define('FRESHRSS_WEBSITE', 'http://github.com/bearer1024/feedReader');
define('FRESHRSS_WIKI', 'http://github.com/bearer1024/feedReader/wiki');
...
define('FRESHRSS_PATH', dirname(__FILE__));
	...
	define('PUBLIC_PATH', FRESHRSS_PATH . '/reader');
		define('PUBLIC_TO_INDEX_PATH', '/index.php');
